# 1 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\system-top.dts" 2
# 1 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  i2s_receiver_0: i2s_receiver@43c00000 {
   aud_mclk = <12286002>;
   ...
   clocks = <&misc_clk_0>, <&misc_clk_0>, <&clkc 15>;
  ...
  i2s_transmitter_0: i2s_transmitter@43c10000 {
   ...
   clocks = <&misc_clk_0>, <&clkc 15>, <&misc_clk_0>;
   xlnx,num-channels = <0x1>;
   xlnx,edk-iptype = "PERIPHERAL";
   xlnx,is-master = <1>;
...
# 4 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\system-top.dts" 2
# 1 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
 ...
 &amba {
  processing_system7_0: processing_system7@0 {
   ...
   xlnx,pcw-act-fpga1-peripheral-freqmhz = <0xbc614f>;
   ...
   xlnx,pcw-package-ddr-dqs-to-clk-delay-0 = <0x9c40>;
   xlnx,pcw-uiparam-ddr-dqs-3-length-mm = <0>;
   xlnx,pcw-package-ddr-dqs-to-clk-delay-1 = <0xe290>;
   ...
   xlnx,pcw-package-ddr-board-delay0 = <0x36718>;
   xlnx,pcw-wdt-peripheral-divisor0 = <1>;
   xlnx,s-axi-hp1-data-width = <64>;
   xlnx,pcw-package-ddr-board-delay1 = <0x33c20>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-1-length-mm = <0x11edd80>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-0-length-mm = <0xee0980>;
   ...
   xlnx,pcw-uiparam-ddr-dq-1-length-mm = <18>;
   ...
   xlnx,pcw-fclk1-peripheral-divisor0 = <27>;
   xlnx,pcw-fclk1-peripheral-divisor1 = <3>;
   ...
   xlnx,pcw-uiparam-ddr-clock-1-length-mm = <0x189ad40>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-to-clk-delay-0 = <0x9c40>;
   xlnx,pcw-uiparam-ddr-dqs-to-clk-delay-1 = <0xe290>;
   xlnx,pcw-uiparam-ddr-dqs-to-clk-delay-2 = <0xffffdcd8>;
   xlnx,pcw-uiparam-ddr-dqs-to-clk-delay-3 = <0xffff7f18>;
   ...
   xlnx,pcw-uiparam-ddr-dq-0-length-mm = <0xfbc520>;
   ...
   xlnx,pcw-uiparam-ddr-clock-0-length-mm = <0x189ad40>;
   ...
   xlnx,pcw-uiparam-ddr-board-delay0 = <0x36718>;
   xlnx,pcw-uiparam-ddr-board-delay1 = <0x33c20>;
   ...
   xlnx,pcw-fpga1-peripheral-freqmhz = <0xbb8000>;
...
# 5 "E:\\Tesis\\Vitis_Loop\\platform_1\\hw\\sdt\\system-top.dts" 2
/ {
 board = "arty-z7-20";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x43c00000 &i2s_receiver_0 0x43c00000 0x10000>,
         <0x43c10000 &i2s_transmitter_0 0x43c10000 0x10000>,
