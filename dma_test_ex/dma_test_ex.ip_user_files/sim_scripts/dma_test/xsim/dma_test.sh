...
#
# Script generated by Vivado on Thu Apr 02 00:46:49 -0300 2026
...
# script info
echo -e "dma_test.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_36 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dma_test xil_defaultlib.dma_test xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dma_test -key {Behavioral:sim_1:Functional:dma_test} -tclbatch cmd.tcl -log simulate.log
}
