...
#
# Script generated by Vivado on Thu Apr 02 00:46:47 -0300 2026
...
# script info
echo -e "axi_bram_ctrl_1.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_bram_ctrl_v4_1_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_bram_ctrl_1 xil_defaultlib.axi_bram_ctrl_1 xil_defaultlib.glbl -log elaborate.log
}
