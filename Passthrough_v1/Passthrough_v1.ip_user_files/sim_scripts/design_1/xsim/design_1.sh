...
#
# Script generated by Vivado on Thu Jul 30 22:23:50 -0300 2026
...
export RDI_DATADIR="X:/Xilinx/2025.1/Vivado/data"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="X:/Xilinx/2025.1/Vivado/data/xsim"
  fi
