...
#
# Script generated by Vivado on Sat Apr 25 22:58:46 -0300 2026
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_21 -L smartconnect_v1_0 -L i2s_receiver_v1_0_10 -L i2s_transmitter_v1_0_10 -L processing_system7_vip_v1_0_23 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L i2s_receiver_v1_0_10 -L i2s_transmitter_v1_0_10 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_36 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_17 -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_13 -L axi_data_fifo_v2_1_35 -L axi_crossbar_v2_1_37 -L axi_protocol_converter_v2_1_36 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L axi_clock_converter_v2_1_34 -L gigantic_mux -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6e42.protoinst" -protoinst "protoinst_files/bd_36ad.protoinst" -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
