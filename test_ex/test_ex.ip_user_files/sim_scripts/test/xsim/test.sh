...
#
# Script generated by Vivado on Wed Apr 01 23:51:15 -0300 2026
...
# script info
echo -e "test.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L i2s_receiver_v1_0_10 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot test xil_defaultlib.test xil_defaultlib.glbl -log elaborate.log
}
