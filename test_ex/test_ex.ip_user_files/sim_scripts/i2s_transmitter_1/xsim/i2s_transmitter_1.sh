...
#
# Script generated by Vivado on Wed Apr 01 23:51:12 -0300 2026
...
#
# Usage        : i2s_transmitter_1.sh
#                i2s_transmitter_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                i2s_transmitter_1.sh [-reset_run]
#                i2s_transmitter_1.sh [-reset_log]
#                i2s_transmitter_1.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L i2s_transmitter_v1_0_10 -L i2s_receiver_v1_0_10"

# script info
echo -e "i2s_transmitter_1.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./i2s_transmitter_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L i2s_transmitter_v1_0_10 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot i2s_transmitter_1 xil_defaultlib.i2s_transmitter_1 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb i2s_transmitter_1.wdb xsim.dir libdpi.so)
...
Usage: i2s_transmitter_1.sh [-step]\n\
Usage: i2s_transmitter_1.sh [-lib_map_path]\n\
Usage: i2s_transmitter_1.sh [-reset_run]\n\
Usage: i2s_transmitter_1.sh [-reset_log]\n\
Usage: i2s_transmitter_1.sh [-keep_index]\n\
