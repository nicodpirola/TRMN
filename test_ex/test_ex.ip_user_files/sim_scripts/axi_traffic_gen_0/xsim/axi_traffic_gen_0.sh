...
#
# Script generated by Vivado on Wed Apr 01 23:51:14 -0300 2026
...
# set xvlog options
xvlog_opts="--incr --relax  -L i2s_transmitter_v1_0_10 -L i2s_receiver_v1_0_10"

# script info
echo -e "axi_traffic_gen_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L axi_traffic_gen_v3_0_21 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_traffic_gen_0 xil_defaultlib.axi_traffic_gen_0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_traffic_gen_0.wdb xsim.dir libdpi.so)
